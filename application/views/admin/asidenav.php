            ...
            <nav id="navside">
                    <ul>
                        ...
                        <li><a href="<?php echo base_url() . 'admin/mobil' ?>"
                                class="<?= (current_url() == base_url('admin/mobil') || current_url() == base_url('admin/mobil_add') || (strpos(current_url(), base_url('admin/mobil_edit')) !== false)) ? 'active' : '' ?>">
                        ...
                        <li><a href="<?php echo base_url() . 'admin/kostumer' ?>"
                                class="<?= (current_url() == base_url('admin/kostumer') || current_url() == base_url('admin/kostumer_add') || (strpos(current_url(), base_url('admin/kostumer_edit')) !== false)) ? 'active' : '' ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                        ...
                        <li><a href="<?php echo base_url() . 'admin/transaksi' ?>"
                        class="<?= (current_url() == base_url('admin/transaksi') || current_url() == base_url('admin/transaksi_add') || (strpos(current_url(), base_url('admin/transaksi_edit')) !== false)) ? 'active' : '' ?>">
                        ...
                        <li><a href="<?php echo base_url() . 'admin/laporan' ?>"
                        class="<?= (current_url() == base_url('admin/laporan') || current_url() == base_url('admin/laporan_add') || (strpos(current_url(), base_url('admin/laporan_edit')) !== false)) ? 'active' : '' ?>">
                        ...
                        <li><a href="<?php echo base_url() . 'admin/tentang' ?>"
                        class="<?= (current_url() == base_url('admin/tentang') || current_url() == base_url('admin/tentang_add') || (strpos(current_url(), base_url('admin/tentang_edit')) !== false)) ? 'active' : '' ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                    <path fill="currentColor"
