            ...
            <section class="main-content">
                <div class="page-location">
                    ...
                    <div class="page-right">
                        ...
                        <!-- icon arrow -->
                        <svg class="arr-right-content" xmlns="http://www.w3.org/2000/svg" width="6" height="13"
                            viewBox="0 0 6 13" fill="none">
                            <path d="M0.887131 11.9918L5.42149 6.2901L0.534351 1.00002" stroke="black"
                ...
                <!-- jumbotron -->
                <div class="jumbotron">
                    <div class="content-left-jumbotron">
                        <img src="<?php echo base_url() . 'assets/heroimage/jumbotron.png' ?>" width="320px"
                            height="197px">
                    </div>

                    <div class="content-right-jumbotron">
                        <div class="wraper-desc-jumbotron">
                            <p class="desc1-jumbotron">Selamat datang <span>Rifqi H. Dai</span> di aplikasi
                                rental mobil <span>superCar</span></p>

                            <p class="desc2-jumbotron">SuperCar adalah aplikasi pengelolaan rental mobil yang
                                digunakan untuk memudahkan mengelola data mobil,
                                data kostumer dan data transaksi.</p>

                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="23"
                                    viewBox="0 0 25 23" fill="none">
                                    <path
                                        d="M23.9258 9.72422C23.7808 9.54329 23.59 9.396 23.3693 9.29453C23.1485 9.19305 22.9041 9.1403 22.6562 9.14062H21.0938V7.73438C21.0938 7.36141 20.9291 7.00373 20.6361 6.74001C20.3431 6.47628 19.9457 6.32812 19.5312 6.32812H12.7607L10.0527 4.5C9.78181 4.31823 9.45315 4.21963 9.11523 4.21875H3.90625C3.49185 4.21875 3.09442 4.36691 2.8014 4.63063C2.50837 4.89435 2.34375 5.25204 2.34375 5.625V18.2812C2.34375 18.4677 2.42606 18.6466 2.57257 18.7784C2.71909 18.9103 2.9178 18.9844 3.125 18.9844H20.6152C20.7792 18.9844 20.939 18.938 21.0721 18.8517C21.2051 18.7654 21.3046 18.6436 21.3564 18.5036L24.1387 10.9916C24.2169 10.7802 24.2384 10.5552 24.2014 10.3349C24.1644 10.1146 24.07 9.90533 23.9258 9.72422ZM9.11523 5.625L11.8232 7.45313C12.0941 7.63501 12.4228 7.73362 12.7607 7.73438H19.5312V9.14062H6.81348C6.48552 9.1406 6.16587 9.23345 5.89981 9.40603C5.63375 9.5786 5.43477 9.82214 5.33105 10.1021L3.90625 13.9482V5.625H9.11523ZM20.0527 17.5781H4.20898L6.81348 10.5469H22.6562L20.0527 17.5781Z"
                                        fill="white" />
                                </svg>
                                <span>Tampilkan Data Mobil</span></a>
                        </div>
                    </div>
                </div>
                <!-- jumbotron end -->
                ...
                <div class="container-card-content">
                    <div class="card mobil">
                        <svg xmlns="http://www.w3.org/2000/svg" width="69" height="69" viewBox="0 0 69 69" fill="none">
                            <path
                                d="M14.375 31.625L18.6875 18.6875H50.3125L54.625 31.625M50.3125 46C49.1688 46 48.0719 45.5456 47.2631 44.7369C46.4544 43.9281 46 42.8312 46 41.6875C46 40.5438 46.4544 39.4468 47.2631 38.6381C48.0719 37.8293 49.1688 37.375 50.3125 37.375C51.4562 37.375 52.5531 37.8293 53.3619 38.6381C54.1706 39.4468 54.625 40.5438 54.625 41.6875C54.625 42.8312 54.1706 43.9281 53.3619 44.7369C52.5531 45.5456 51.4562 46 50.3125 46ZM18.6875 46C17.5438 46 16.4469 45.5456 15.6381 44.7369C14.8294 43.9281 14.375 42.8312 14.375 41.6875C14.375 40.5438 14.8294 39.4468 15.6381 38.6381C16.4469 37.8293 17.5438 37.375 18.6875 37.375C19.8312 37.375 20.9281 37.8293 21.7369 38.6381C22.5456 39.4468 23 40.5438 23 41.6875C23 42.8312 22.5456 43.9281 21.7369 44.7369C20.9281 45.5456 19.8312 46 18.6875 46ZM54.395 17.25C53.82 15.5825 52.21 14.375 50.3125 14.375H18.6875C16.79 14.375 15.18 15.5825 14.605 17.25L8.625 34.5V57.5C8.625 58.2625 8.9279 58.9938 9.46707 59.5329C10.0062 60.0721 10.7375 60.375 11.5 60.375H14.375C15.1375 60.375 15.8688 60.0721 16.4079 59.5329C16.9471 58.9938 17.25 58.2625 17.25 57.5V54.625H51.75V57.5C51.75 58.2625 52.0529 58.9938 52.5921 59.5329C53.1312 60.0721 53.8625 60.375 54.625 60.375H57.5C58.2625 60.375 58.9938 60.0721 59.5329 59.5329C60.0721 58.9938 60.375 58.2625 60.375 57.5V34.5L54.395 17.25Z"
                                fill="#E4E4E4" />
                        </svg>

                        <div class="wraper-card-desc">
                            <p class="card-desc">Jumlah Mobil</p>
                            <p class="card-count">7</p>
                        </div>
                    </div>

                    <div class="card kostumer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="69" height="69" viewBox="0 0 69 69" fill="none">
                            <path
                                d="M14.375 31.625L18.6875 18.6875H50.3125L54.625 31.625M50.3125 46C49.1688 46 48.0719 45.5456 47.2631 44.7369C46.4544 43.9281 46 42.8312 46 41.6875C46 40.5438 46.4544 39.4468 47.2631 38.6381C48.0719 37.8293 49.1688 37.375 50.3125 37.375C51.4562 37.375 52.5531 37.8293 53.3619 38.6381C54.1706 39.4468 54.625 40.5438 54.625 41.6875C54.625 42.8312 54.1706 43.9281 53.3619 44.7369C52.5531 45.5456 51.4562 46 50.3125 46ZM18.6875 46C17.5438 46 16.4469 45.5456 15.6381 44.7369C14.8294 43.9281 14.375 42.8312 14.375 41.6875C14.375 40.5438 14.8294 39.4468 15.6381 38.6381C16.4469 37.8293 17.5438 37.375 18.6875 37.375C19.8312 37.375 20.9281 37.8293 21.7369 38.6381C22.5456 39.4468 23 40.5438 23 41.6875C23 42.8312 22.5456 43.9281 21.7369 44.7369C20.9281 45.5456 19.8312 46 18.6875 46ZM54.395 17.25C53.82 15.5825 52.21 14.375 50.3125 14.375H18.6875C16.79 14.375 15.18 15.5825 14.605 17.25L8.625 34.5V57.5C8.625 58.2625 8.9279 58.9938 9.46707 59.5329C10.0062 60.0721 10.7375 60.375 11.5 60.375H14.375C15.1375 60.375 15.8688 60.0721 16.4079 59.5329C16.9471 58.9938 17.25 58.2625 17.25 57.5V54.625H51.75V57.5C51.75 58.2625 52.0529 58.9938 52.5921 59.5329C53.1312 60.0721 53.8625 60.375 54.625 60.375H57.5C58.2625 60.375 58.9938 60.0721 59.5329 59.5329C60.0721 58.9938 60.375 58.2625 60.375 57.5V34.5L54.395 17.25Z"
                                fill="#E4E4E4" />
